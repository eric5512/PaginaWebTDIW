    ...
    <div id="barra_filtro">
        ...
        <select id="categoria_filter" >
            ...
            <?php foreach ($categorias as $cat) {?>
                <option <?php echo "value='".htmlentities($cat['categoria_id'], ENT_QUOTES | ENT_HTML5, "utf-8")."'"; ?> <?php if ($c == $cat['categoria_id']) echo "selected"; ?>><?php echo htmlentities($cat["nom"], ENT_QUOTES | ENT_HTML5, "utf-8") ?></option>
            <?php } ?>
        </select>
    </div>
